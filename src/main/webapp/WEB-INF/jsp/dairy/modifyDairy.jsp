                    ...
                    <form id="add_dairy" data-parsley-validate class="form-horizontal form-label-left" role="form">
                            ...
                            <div class="col-md-4 col-sm-4 col-xs-12">
                                <select class="select2_single form-control" tabindex="-1" id="price_select">
                                    <c:forEach var="priceType" items="${priceTypes}">
                                        <option value="${priceType.id}" <c:if test="${dairy.priceId == priceType.id}">selected="selected"</c:if>>${priceType.name}</option>
                                    </c:forEach>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                ...
                                <button type="button" class="btn createbtn btn-primary" onclick="dairy.getList(${dairy.priceId})">取消</button>
                            </div>
                        </div>
                    </form>
                </div>
