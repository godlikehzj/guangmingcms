            ...
            <div class="x_panel">
                ...
                <div class="x_content">
                    ...
                    <form id="add_user" data-parsley-validate class="form-horizontal form-label-left" role="form">
                        <input type="text" id="customer_id" class="none" value="${customer.id}">
                        <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">姓名<span class="required">*</span>
                            </label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" id="name" required="required" value="${customer.name}" class="form-control col-md-7 col-xs-12">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" id="mobile" name="mobile" required="required" value="${customer.mobile}" class="form-control col-md-7 col-xs-12">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-4 col-sm-4 col-xs-12">
                                <input type="text" id="addr" name="addr" required="required" value="${customer.addr}" class="form-control col-md-7 col-xs-12">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-12">
                                <select class="select2_single form-control" tabindex="-1" id="area_select">
                                    ...
                                    <c:forEach var="area" items="${areas}">
                                        <option value="${area.id}" <c:if test="${customer.area == area.id}">selected="selected"</c:if>>${area.name}</option>
                                    </c:forEach>
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <div id="channel" class="btn-group" data-toggle="buttons">
                                    <label class="btn" data-toggle-class="btn-primary" data-toggle-passive-class="btn-default">
                                        到店:<input type="radio" class="flat" name="status" id="admin" value="0" <c:if test="${customer.channel == 0}">checked="checked"</c:if>/>
                                    </label>
                                    <label class="btn" data-toggle-class="btn-primary" data-toggle-passive-class="btn-default">
                                        奶工:<input type="radio" class="flat" name="status" id="worker" value="1" <c:if test="${customer.channel == 1}">checked="checked"</c:if> />
                                    </label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                <button type="button" class="btn createbtn btn-success" onclick="modifyCustomer()">修改</button>
